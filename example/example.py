...
f = 'C:/Users/Gabrielle/Documents/GitHub/medpc2excel/example/Magazine_wCameras.MPC'

# medpc_read function return two outpus.
# the first one is actual data

# if you don't want export you data into *.xlsx file
data, f = medpc_read(f,save=False)  

# if you do want a *.xlsx file (default is save)
data, f = medpc_read(f)  # note that data is a dict-liked data structure
